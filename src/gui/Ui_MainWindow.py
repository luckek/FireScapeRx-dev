...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.fuel_type_legend_label_3 = QtWidgets.QLabel(self.verticalLayoutWidget_4)
        self.fuel_type_legend_label_3.setAlignment(QtCore.Qt.AlignCenter)
        self.fuel_type_legend_label_3.setObjectName("fuel_type_legend_label_3")
        self.verticalLayout_4.addWidget(self.fuel_type_legend_label_3)
        ...
        self.x_range_min_line_edit_3 = QtWidgets.QLineEdit(self.verticalLayoutWidget_4)
        self.x_range_min_line_edit_3.setObjectName("x_range_min_line_edit_3")
        self.gridLayout_3.addWidget(self.x_range_min_line_edit_3, 0, 2, 1, 1)
        self.label_11 = QtWidgets.QLabel(self.verticalLayoutWidget_4)
        self.label_11.setObjectName("label_11")
        self.gridLayout_3.addWidget(self.label_11, 1, 0, 1, 1)
        self.y_range_max_line_edit_3 = QtWidgets.QLineEdit(self.verticalLayoutWidget_4)
        self.y_range_max_line_edit_3.setPlaceholderText("")
        self.y_range_max_line_edit_3.setObjectName("y_range_max_line_edit_3")
        self.gridLayout_3.addWidget(self.y_range_max_line_edit_3, 1, 4, 1, 1)
        self.x_range_max_line_edit_3 = QtWidgets.QLineEdit(self.verticalLayoutWidget_4)
        self.x_range_max_line_edit_3.setObjectName("x_range_max_line_edit_3")
        self.gridLayout_3.addWidget(self.x_range_max_line_edit_3, 0, 4, 1, 1)
        ...
        self.y_range_min_line_edit_3 = QtWidgets.QLineEdit(self.verticalLayoutWidget_4)
        self.y_range_min_line_edit_3.setObjectName("y_range_min_line_edit_3")
        self.gridLayout_3.addWidget(self.y_range_min_line_edit_3, 1, 2, 1, 1)
        ...
        self.fuel_type_combo_box_3 = QtWidgets.QComboBox(self.verticalLayoutWidget_4)
        self.fuel_type_combo_box_3.setObjectName("fuel_type_combo_box_3")
        self.fuel_type_combo_box_3.addItem("")
        self.fuel_type_combo_box_3.addItem("")
        self.horizontalLayout_9.addWidget(self.fuel_type_combo_box_3)
        ...
        self.fuel_type_combo_box_3.setCurrentIndex(0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.fuel_type_legend_label_3.setText(_translate("MainWindow", "Ignition Point Map Legend:"))
        ...
        self.fuel_type_combo_box_3.setCurrentText(_translate("MainWindow", "No-Ignition"))
        self.fuel_type_combo_box_3.setItemText(0, _translate("MainWindow", "No-Ignition"))
        self.fuel_type_combo_box_3.setItemText(1, _translate("MainWindow", "Ignition"))
