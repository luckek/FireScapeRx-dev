...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ignition_point_scroll_area.setGeometry(QtCore.QRect(0, 0, 360, 530))
        ...
        self.ignition_point_scroll_area_widget_contents.setGeometry(QtCore.QRect(0, 0, 358, 528))
        ...
        self.verticalLayoutWidget_4.setGeometry(QtCore.QRect(20, 0, 321, 331))
        ...
        self.ingition_point_map_legend_scroll_area_widget_contents.setGeometry(QtCore.QRect(0, 0, 317, 109))
        ...
        self.x_range_ign_point_min_line_edit = QtWidgets.QLineEdit(self.verticalLayoutWidget_4)
        self.x_range_ign_point_min_line_edit.setObjectName("x_range_ign_point_min_line_edit")
        self.gridLayout_3.addWidget(self.x_range_ign_point_min_line_edit, 0, 2, 1, 1)
        self.label_11 = QtWidgets.QLabel(self.verticalLayoutWidget_4)
        self.label_11.setObjectName("label_11")
        self.gridLayout_3.addWidget(self.label_11, 1, 0, 1, 1)
        self.y_range_ign_point_max_line_edit = QtWidgets.QLineEdit(self.verticalLayoutWidget_4)
        self.y_range_ign_point_max_line_edit.setPlaceholderText("")
        self.y_range_ign_point_max_line_edit.setObjectName("y_range_ign_point_max_line_edit")
        self.gridLayout_3.addWidget(self.y_range_ign_point_max_line_edit, 1, 4, 1, 1)
        self.x_range_ign_point_max_line_edit = QtWidgets.QLineEdit(self.verticalLayoutWidget_4)
        self.x_range_ign_point_max_line_edit.setObjectName("x_range_ign_point_max_line_edit")
        self.gridLayout_3.addWidget(self.x_range_ign_point_max_line_edit, 0, 4, 1, 1)
        ...
        self.y_range_ign_point_min_line_edit = QtWidgets.QLineEdit(self.verticalLayoutWidget_4)
        self.y_range_ign_point_min_line_edit.setObjectName("y_range_ign_point_min_line_edit")
        self.gridLayout_3.addWidget(self.y_range_ign_point_min_line_edit, 1, 2, 1, 1)
        ...
        self.ign_point_combo_box = QtWidgets.QComboBox(self.verticalLayoutWidget_4)
        self.ign_point_combo_box.setObjectName("ign_point_combo_box")
        self.ign_point_combo_box.addItem("")
        self.ign_point_combo_box.addItem("")
        self.horizontalLayout_9.addWidget(self.ign_point_combo_box)
        ...
        self.modify_ign_points_button = QtWidgets.QPushButton(self.verticalLayoutWidget_4)
        self.modify_ign_points_button.setObjectName("modify_ign_points_button")
        self.horizontalLayout_10.addWidget(self.modify_ign_points_button)
        ...
        self.tab_widget.addTab(self.ignition_point_legend_tab, "")
        ...
        self.sim_title_label = QtWidgets.QLabel(self.horizontalLayoutWidget)
        self.sim_title_label.setObjectName("sim_title_label")
        self.horizontalLayout_2.addWidget(self.sim_title_label)
        self.ign_point_scroll_area = QtWidgets.QScrollArea(self.central_widget)
        self.ign_point_scroll_area.setGeometry(QtCore.QRect(9, 50, 581, 511))
        self.ign_point_scroll_area.setWidgetResizable(True)
        self.ign_point_scroll_area.setObjectName("ign_point_scroll_area")
        self.ign_point_scroll_area_widget_contents = QtWidgets.QWidget()
        self.ign_point_scroll_area_widget_contents.setGeometry(QtCore.QRect(0, 0, 579, 509))
        self.ign_point_scroll_area_widget_contents.setObjectName("ign_point_scroll_area_widget_contents")
        self.ign_point_scroll_area.setWidget(self.ign_point_scroll_area_widget_contents)
        ...
        self.ign_point_combo_box.setCurrentIndex(0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_11.setText(_translate("MainWindow", "Y range:"))
        self.label_12.setText(_translate("MainWindow", "X range:"))
        self.label_13.setText(_translate("MainWindow", "-"))
        self.label_14.setText(_translate("MainWindow", "-"))
        self.label_15.setText(_translate("MainWindow", "Fuel Type:"))
        self.ign_point_combo_box.setCurrentText(_translate("MainWindow", "No-Ignition"))
        self.ign_point_combo_box.setItemText(0, _translate("MainWindow", "No-Ignition"))
        self.ign_point_combo_box.setItemText(1, _translate("MainWindow", "Ignition"))
        self.modify_ign_points_button.setText(_translate("MainWindow", "Modify"))
        self.tab_widget.setTabText(self.tab_widget.indexOf(self.ignition_point_legend_tab), _translate("MainWindow", "Ignition Points"))
        self.sim_title_label.setText(_translate("MainWindow", "Simulation Title:"))
